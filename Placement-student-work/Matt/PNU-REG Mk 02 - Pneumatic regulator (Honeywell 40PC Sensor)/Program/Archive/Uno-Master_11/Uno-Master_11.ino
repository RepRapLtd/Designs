...
int lineCounter;
int pMinIn = pMin-2; // Variation on pMin to allow for innacuracy in pressure sent before triggering actionCodes
...
void actionCodeRead(){
  ...
  Serial.print(pReading);
      ...
      if (pReading == emergencyStop) {
      pSetting = emergencyStop;
      lineBreak(1);
      Serial.print("EMERGENCY STOP");
      lineBreak(2);
      }
