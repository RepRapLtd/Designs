...
const int motorInterval = 50; //Time that the motor runs for small adjustments (500)
...
void motorUp() {
  /*signalConvert();
  analogWrite(anOutUp, motorPWM);
  digitalWrite(anOutDn, 0);
  tws_delay(motorInterval);*/
  digitalWrite(anOutDn, 0);
