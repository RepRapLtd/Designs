...
#define PORT "/dev/modem"  // Port minicom talks to
#define STEP 25000         // Number of microseconds to wait between movements
#define ME 255             // Identity of the computer in the token ring
#define PL 7               // Packet length
